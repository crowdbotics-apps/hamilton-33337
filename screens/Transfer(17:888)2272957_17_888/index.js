...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        style={styles.TouchableOpacity_21_53}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("21_61"))
        }
      >
        <View style={styles.View_17_969} />
        <View style={styles.View_21_39}>
          <View style={styles.View_21_40} />
          <View style={styles.View_21_41}>
            <Text style={styles.Text_21_41}>SEND</Text>
          </View>
        </View>
        <View style={styles.View_19_129}>
          <View style={styles.View_21_3}>
            <View style={styles.View_21_0} />
            <View style={styles.View_21_48}>
              <Text style={styles.Text_21_48}>Julia</Text>
            </View>
          </View>
          <View style={styles.View_21_4}>
            <View style={styles.View_21_5} />
            <View style={styles.View_21_49}>
              <Text style={styles.Text_21_49}>Andrew</Text>
            </View>
          </View>
          <View style={styles.View_21_7}>
            <View style={styles.View_21_8} />
            <View style={styles.View_21_50}>
              <Text style={styles.Text_21_50}>Susan</Text>
            </View>
          </View>
          <View style={styles.View_21_10}>
            <View style={styles.View_21_11} />
            <View style={styles.View_21_51}>
              <Text style={styles.Text_21_51}>James</Text>
            </View>
          </View>
          <View style={styles.View_21_13}>
            <View style={styles.View_21_14} />
            <View style={styles.View_21_52}>
              <Text style={styles.Text_21_52}>Bella</Text>
            </View>
          </View>
          <View style={styles.View_19_155}>
            <Text style={styles.Text_19_155}>Receiver</Text>
          </View>
          <View style={styles.View_21_42}>
            <Text style={styles.Text_21_42}>More</Text>
          </View>
        </View>
        <View style={styles.View_19_178}>
          <View style={styles.View_21_35}>
            <View style={styles.View_21_24}>
              <View style={styles.View_21_19} />
              <View style={styles.View_21_21}>
                <Text style={styles.Text_21_21}>100</Text>
              </View>
            </View>
            <View style={styles.View_21_26}>
              <View style={styles.View_21_27} />
              <View style={styles.View_21_28}>
                <Text style={styles.Text_21_28}>700</Text>
              </View>
            </View>
            <View style={styles.View_21_23}>
              <View style={styles.View_21_20} />
              <View style={styles.View_21_22}>
                <Text style={styles.Text_21_22}>200</Text>
              </View>
            </View>
            <View style={styles.View_21_29}>
              <View style={styles.View_21_30} />
              <View style={styles.View_21_31}>
                <Text style={styles.Text_21_31}>1.000</Text>
              </View>
            </View>
            <View style={styles.View_21_25}>
              <View style={styles.View_21_18} />
              <View style={styles.View_21_16}>
                <Text style={styles.Text_21_16}>50</Text>
              </View>
            </View>
            <View style={styles.View_21_32}>
              <View style={styles.View_21_33} />
              <View style={styles.View_21_34}>
                <Text style={styles.Text_21_34}>400</Text>
              </View>
            </View>
          </View>
          <View style={styles.View_19_180}>
            <Text style={styles.Text_19_180}>Transfer Amount</Text>
          </View>
          <View style={styles.View_19_181}>
            <Text style={styles.Text_19_181}>$</Text>
          </View>
          <View style={styles.View_19_182}>
            <Text style={styles.Text_19_182}>1.000</Text>
          </View>
        </View>
        <View style={styles.View_21_54}>
          <View style={styles.View_19_168}>
            <Text style={styles.Text_19_168}>$ 450.500,24</Text>
          </View>
          <View style={styles.View_21_36}>
            <Text style={styles.Text_21_36}>Main Wallet</Text>
          </View>
          <View style={styles.View_21_37}>
            <Text style={styles.Text_21_37}>Change</Text>
          </View>
        </View>
      </TouchableOpacity>
      <View style={styles.View_17_892}>
        <View style={styles.View_17_893}>
          ...
          <ImageBackground
            ...
            style={styles.ImageBackground_17_898}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_17_902}
          />
          <View style={styles.View_17_907}>
            <Text style={styles.Text_17_907}>9:41</Text>
          </View>
        </View>
        <View style={styles.View_19_170}>
          <Text style={styles.Text_19_170}>Transfer</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_21_38}
        />
      </View>
      <View style={styles.View_17_928}>
        <View style={styles.View_17_929}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/ebc8/fcbd/624e83a64b9b69a2f8d9eed64bd5c8dc"
            }}
            style={styles.ImageBackground_17_930}
          />
          <View style={styles.View_17_931} />
        </View>
      </View>
    </ScrollView>
  )
